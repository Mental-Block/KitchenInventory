...
import { UNITS, CATEGORIES } from "./defaultItemData"
...
export default function AddItems({ ...props }) {
  ...
  const unitFetch = useFetch("/api/units/all", { method: "GET", headers: { "x-auth-token": props.token } }, unit.reload)
  const categoryFetch = useFetch("/api/categories/all", { method: "GET", headers: { "x-auth-token": props.token } }, category.reload)
  ...
  return (
    <>
      ...
      <Prompt
        ...
        fetch={{
          url: "/api/units/add",
          options: { method: "POST", headers: { "content-type": "application/json", "x-auth-token": props.token } }
        }}
        input={{
          name: "unit",
          label: "Add Unit",
